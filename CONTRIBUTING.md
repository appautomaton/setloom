...
Setloom welcomes contributions from independent developers, musicians, and technically curious creators.

## Contribution Rules

- Keep public docs and harness prompts in clear English.
...
Contributions should use DCO sign-off:
